...
export default function generateContent(dataTip){
    ...
    switch(dataTip){
        case 'create':
            return <TipContent title='Create a playlist' tip='Login to create and share playlists.'/>
        case 'list':
    ...
    return(
        <div className="tipContent">
            ...
            <div className="tipOptions">
                ...
                <PromptButton name={`${process.env.REACT_APP_BACK_URI}/login`} name='Log In' styleName='light'/>
            </div>
        </div>
    )
}