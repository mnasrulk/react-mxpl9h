...
export default function AlbumPage() {
    ...
    useEffect(() => {
        ...
        if(id){
            makeRequest()
            .then((data) => {
                const {album_type, name, primary_color, tracks, images, release_date, uri} = data
    ...
    return (
        ...
        <div className='listPage' style={{display:`${tracks.length===0? 'none':'block'}`}}>
            ...
            <div className="playListContent">
                ...
                <PlayListFunctions onFollow={() => setMessage('Oops look like the spotify API does not support following albums')} setMessage={setMessage} playContext={playContext}/>
