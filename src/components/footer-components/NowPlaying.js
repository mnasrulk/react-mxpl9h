    ...
    return (
        <div className="now-playing">
            ...
            <div className="player-like" style={{display: name === ''? 'none':null}}>
                <button title='Save to your Liked Songs' className="player-like-button no-outline" onClick={() => setMessage(`Opps, it look like I chose not to implement this feature`)}>
                    <Icon name='Heart'/>
                </button>
            </div>
        </div>
